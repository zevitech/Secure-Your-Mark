    ...
    <div>
      <div className="col-flex justify-center items-center gap-5 max-w-4xl m-auto  max-md:px-3 mb-10">
        <h1 className="text-4xl max-md:text-3xl max-md:mb-3 text-slate-800 font-medium">
          Choose the Best Business Structure for Trademark Protection
        </h1>
      ...
      <div className="flex flex-wrap justify-center items-center gap-5">
        <div className="w-[550px] bg-white rounded-lg p-10 custom-shadow h-full hover:bg-[#F25601] text-slate-700 hover:text-white transition-all">
