...
export const tpme = [
  {
    id: 1,
    title: "Share Your Brand Essentials",
    details:
      "Tell us about your trademark details—brand name, logo, or slogan you want to safeguard. Our experts will gather the necessary information to start the registration process to trademark my name or trademark my business name.",
  },
  {
    id: 2,
    title: "Comprehensive Trademark Search",
    details:
      "After collecting your details, our experts will perform a thorough trademark search. This helps us check if your chosen mark is free for use and identifies any potential conflicts making it the best trademark registration service.",
  },
  {
    id: 3,
...
export const canBeTrademarked = [
  ...
  {
    id: 2,
    title: "Logos: 'The iconic Walmart Swoosh'",
  },
  {
    id: 3,
    title: "Slogans: Save Money. Live better.",
  },
];

export const canNotBeTrademarked = [
  {
    id: 1,
    title:
      "Songs, books, films, or other work—it's important to get a copyright",
  },
  {
    id: 2,
    title:
